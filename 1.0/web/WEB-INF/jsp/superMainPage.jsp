...
<%--                <dd><a onclick="x_admin_show('切换帐号','loginOut')">切换帐号</a></dd>--%>
                <dd><a href="${pageContext.request.contextPath}/login/out">切换账号</a></dd>
            </dl>
        </li>
    ...
    <div id="side-nav">
        <ul id="nav">
            <li>
                ...
                <ul class="sub-menu">
                    <li>
                        <a _href="${pageContext.request.contextPath}/super/allUserinfo">
                            <%--点击在右侧出现动态的Tab--%>
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>用户管理</cite>
            ...
            <li>
                ...
                <ul class="sub-menu">
                    <li>
                        <a _href="${pageContext.request.contextPath}/super/allFactory">
                            <%--点击在右侧出现动态的Tab--%>
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>云工厂信息</cite>
                        </a>
            ...
            <li>
                ...
                <ul class="sub-menu">
                    <li>
                        <a _href="${pageContext.request.contextPath}/super/allProductType">
                            <%--点击在右侧出现动态的Tab--%>
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>产品类别管理</cite>
                        </a>
                    ...
                    <li>
                        <a _href="${pageContext.request.contextPath}/super/allProduct">
                            <%--点击在右侧出现动态的Tab--%>
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>产品信息管理</cite>
                        </a>
            ...
            <li>
                ...
                <ul class="sub-menu">
                    <li>
                        <a _href="${pageContext.request.contextPath}/super/allDeviceType">
                            <%--点击在右侧出现动态的Tab--%>
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>设备类别管理</cite>
                        </a>
                ...
                <ul class="sub-menu">
                    <li>
                        <a _href="${pageContext.request.contextPath}/super/allDevice">
                            <%--点击在右侧出现动态的Tab--%>
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>设备信息管理</cite>
                        </a>
            ...
            <li>
                ...
                <ul class="sub-menu">
                    <li>
                        <a _href="${pageContext.request.contextPath}/super/allOrder">
                            <%--点击在右侧出现动态的Tab--%>
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>订单基本信息</cite>
                        </a>
...
<div class="page-content">
    <div class="layui-tab tab" lay-filter="xbs_tab" lay-allowclose="false">
        <ul class="layui-tab-title">
            <li class="home"><i class="layui-icon">&#xe68e;</i>个人信息</li>
        </ul>
        <div class="layui-tab-content" >
            <div class="layui-tab-item layui-show o_div" >
                <span class="o_span">${sessionScope.userinfo.username}管理员，欢迎来到云工厂智能制造系统！</span>
...
<%--                        <div class="layui-card-body">--%>
<%--                            <a href="${pageContext.request.contextPath}/super/toUpdateUserinfo/${sessionScope.userinfo.ID}}">更改个人信息</a>--%>
<%--                        </div>--%>
