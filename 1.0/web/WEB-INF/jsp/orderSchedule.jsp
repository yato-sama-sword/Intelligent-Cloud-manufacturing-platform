...
<head>
    ...
    <meta name="viewport" content="width=Schedule-width,user-scalable=yes, minimum-scale=0.4, initial-scale=0.8,target-densitydpi=low-dpi" />
...
<div class="x-nav">
    ...
    <a class="layui-btn layui-btn-small" style="line-height:1.6em;margin-top:3px;float:right" href="${pageContext.request.contextPath}/factory/mySchedule" title="刷新">
        <i class="layui-icon" style="line-height:30px">ဂ</i></a>
</div>
<div class="x-body">
    <div class="layui-row">
        <form class="layui-form layui-col-md12 x-so" action="${pageContext.request.contextPath}/factory/mySchedule" >
    ...
    <a class="alert-link" href="${pageContext.request.contextPath}/factory/allSchedule">排产列表</a>
    ...
    <table class="layui-table" >
        ...
        <c:forEach items="${orderList}" var="order">
            <tr>
                ...
                <td>
                    <a class="layui-table-link" data-toggle="modal" data-target="#addScheduleModal"
                       data-orderid = "${order.ID}"> 排产 </a>
                </td>
            </tr>
        </c:forEach>
        </tbody>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">排产</h5>
            ...
            <div class="modal-body text-left">
                <form accept-charset="utf-8" action="${pageContext.request.contextPath}/factory/addSchedule">
                    <div class="form-group" style="display: none">
                        <label>订单id</label>
                        <input id="addScheduleModalOrderId"
                               class="form-control"
                               name="orderid"
                            required>
                    </div>
                    ...
                    <div class="form-group">
                        <label>设备</label>
                        <select id="addScheduleModalDevice"
                                class="form-control"  name="deviceid" required>
                    ...
                    <div class="form-group">
                        <label>开始日期</label>
                        <input id="addScheduleModalBeginDate"
                               class="form-control"
                               type="date"
                               name="begindate"
                            required>
                    ...
                    <div class="form-group">
                        <label>结束日期</label>
                        <input id="addScheduleModalEndDate"
                               class="form-control"
                               type="date"
                               name="enddate"
                            required>
...
<script>
    $('#addScheduleModal').on('show.bs.modal', function (e) {
        ...
        $('#addScheduleModalOrderId').val(orderid)
    });
    <!-- 以下是为了确保layui可以用 -->
