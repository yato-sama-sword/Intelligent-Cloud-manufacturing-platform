...
<body>
<c:if test="${not empty err || not empty msg || not empty regSuccess}">
  <script>alert('${err} ${msg} ${regSuccess}' )</script>
</c:if>
...
<section>
  ...
  <div class="form-box">
    ...
    <form action="${pageContext.request.contextPath}/login/view" method="post">
      <div class="form-fields">
        <p>
          <label>
            <input class="icoTip ico-account" type="text" name="account" placeholder="账号" required>
          </label>
        </p>
        <p>
          <label>
            <input class="icoTip ico-password" name="password" type="password" placeholder="密码" required>
          </label>
        </p>
      </div>
      <div class="form-action">
        <span>
            <a href="${pageContext.request.contextPath}/login/toReg">注册</a>
        </span>
        <span>
...
<script type="text/javascript" src="${pageContext.request.contextPath}/static/js/jquery-3.2.1.min.js" >
