...
<div class="x-body">
  ...
  <a href="${pageContext.request.contextPath}/factory/toRentDevice" class="alert-link">
    <i class="fas fa-box-open"></i>&nbsp;租用设备
  </a>
  ...
  <table class="layui-table" >
    ...
    <c:forEach items="${deviceList}" var="device">
      <tr>
        ...
        <td class="td-manage">
          <a href="${pageContext.request.contextPath}/factory/toAddCapacity/${device.ID}">配置产能</a>
          <c:if test="${device.devicestatus == 0 || device.devicestatus == 2}">
            <a title="开关" class="layui-table-link" href="${pageContext.request.contextPath}/factory/ocDevice/${device.ID}"
               onclick="if(${device.devicestatus == 0}){
                       alert('设备开启');
                       } else{
                       alert('设备关停')
                       }">
              <i class="layui-icon">开关</i>
            </a>
          </c:if>

          <c:if test="${device.rentstatus == 0}">
            <a title="更新"
            ...
            <a title="删除" href="${pageContext.request.contextPath}/factory/delDevice/${device.ID}">
              <i class="layui-icon">&#xe640;</i>
            </a>
          </c:if>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body text-left">
        <form accept-charset="utf-8" action="${pageContext.request.contextPath}/factory/addDevice">
...
<div class="modal fade" id="updateDeviceModal" tabindex="-1" role="dialog"
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body text-left">
        <form accept-charset="utf-8" action="${pageContext.request.contextPath}/factory/updateDevice">
